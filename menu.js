...
// "Add Feature" button (Initially hidden until Admin access is granted)
...
// "OP Menu" button
const opMenuButton = document.createElement("button");
opMenuButton.innerText = "OP Menu";
opMenuButton.style.width = "100%";
opMenuButton.style.padding = "10px";
opMenuButton.style.backgroundColor = "#333";
opMenuButton.style.color = "white";
opMenuButton.style.border = "none";
opMenuButton.style.cursor = "pointer";
opMenuButton.style.fontFamily = "Arial, sans-serif";
opMenuButton.style.marginBottom = "10px";
buttonContainer.appendChild(opMenuButton);

// OP Menu button functionality placeholder
opMenuButton.addEventListener("click", () => {
(async() => {
...
// Settings button functionality - Display W.I.P alert
...
adminButton.style.fontFamily = "Arial, sans-serif";
adminButton.style.marginBottom = "15px";
buttonContainer.appendChild(adminButton);

// Admin button functionality - Password check
adminButton.addEventListener("click", () => {
    const password = prompt("Enter Admin Password:");
    if (password === "Carboy6104)") {
        alert("Access Granted!");
        addButton.style.display = "block"; // Show Add Feature button
    } else {
        alert("Access Denied!");
    }
});
...
function createFeatureButton(name, code) {
    ...
    buttonContainer.appendChild(featureButton);
}
